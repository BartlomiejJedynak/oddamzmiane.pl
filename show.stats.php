<div class="actual_stats">
    <?php
        ...
        if($_SESSION['make_sure']=="empty"){
            ...
            // else{
            //     echo "oddał:<br>";
            //     if($tm!=0){echo array_sum($tm)." h - w tym miesiącu<br>";}//show given h;
            //     if(isset($am[$nr])){echo array_sum($am)." h - zeszly mies<br>";}
            //     //show given h;
            //     echo array_sum($qwe)." h - ostatnie 3 mies (bez aktualnego)<br>";//show given h in last 3 months;
            //     echo array_sum($all)." h - od poczatku<br>";//show all given h;
            // }
            if(isset($tm))echo array_sum($tm)."h - ".$this_m."<br>";
            if(isset($am))echo array_sum($am)."h - ".$last_m."<br>";
            // if(isset($qwe))echo array_sum($qwe)."<br>.";
